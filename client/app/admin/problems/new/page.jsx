    ...
    <div className="w-full bg-linear-to-b from-white via-wisconsin-gray/20 to-white min-h-screen">
      <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          <Link
            href="/admin/problems"
            className="inline-flex items-center gap-5 text-sm font-medium text-chesapeake hover:text-monarch-900 mb-4 transition-colors"
          >
            <svg
              className="h-4 w-4"
              fill="none"
          ...
          <p className="mt-2 text-monarch-900/70">
            Add a new CTF challenge for participants to solve
          </p>
        </div>
        ...
        <form onSubmit={onSubmit} className="space-y-6">
          <div className="rounded-3xl border border-monarch-900/10 bg-white p-6 shadow-sm">
            ...
            <div>
              <label className="mb-2 block text-sm font-semibold text-monarch-900">
                Flag Answer <span className="text-red-500 ml-1">*</span>
              </label>
