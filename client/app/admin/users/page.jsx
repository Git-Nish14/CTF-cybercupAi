...
export default function AdminUsersPage() {
  ...
  const getRoleBadge = (isAdmin) => {
    return isAdmin ? (
      <span className="inline-flex items-center gap-1.5 rounded-full border border-[#0D6BA8]/20 bg-[#98C5EA]/10 px-3 py-1 text-xs font-medium text-[#0D6BA8]">
        <svg
      ...
      <span className="inline-flex items-center gap-1.5 rounded-full border border-[#828A8F]/20 bg-[#828A8F]/10 px-3 py-1 text-xs font-medium text-[#828A8F]">
        <svg
          className="h-3.5 w-3.5"
          fill="none"
          stroke="currentColor"
                      ...
                      >
                        ...
                        <td className="px-6 py-4 text-right">
                          <Link href={`/admin/users/${u._id}`}>
                            <button className="inline-flex items-center gap-2 rounded-lg border border-[#0D6BA8]/40 bg-white px-4 py-2 text-sm font-medium text-[#0D6BA8] transition-all hover:border-[#0D6BA8] hover:bg-[#98C5EA]/5">
                              <svg
                                className="h-4 w-4"
                                fill="none"
                                stroke="currentColor"
